...
// @name        ion custom
// @namespace   Vidu
// @include     https://muj.dvois.com/24online/webpages/client.jsp
// @version     1
// @resource im bgr.jpg
...
function checkTime(i) {
 ...
 // document.getElementsByTagName('body') [0].style.background = 'url(https://wallpaperscraft.com/image/space_planet_light_night_sky_94442_3840x2160.jpg)';
  ...
  button2.style.padding = '14px 0px 13px 0px';
  ...
  if(document.getElementsByClassName("buttonstyle")[0].name === "logout"){
